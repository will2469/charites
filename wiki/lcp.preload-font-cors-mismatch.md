...
flowchart TD
    ...
    IgnoreCheck -- "Not Ignored" --> Diag["4. Emit Diagnostic: lcp.preload-font-cors-mismatch"]
```

### Step-by-Step Evaluation:
1. **AST Traversal:** Visits normalized `ir.Node` structures during AST streaming.
2. **Invariant Check:** Compares node attributes against rule invariants.
3. **Directive Suppression Check:** Honors inline `charites:ignore lcp.preload-font-cors-mismatch` directives.
...
This rule is rigorously tested and validated across the canonical **1-SSOT Tri-Corpus** in `tests/correctness/lcp.preload-font-cors-mismatch/`:

```mermaid
flowchart TD
    subgraph GoldenCorpus ["1-SSOT Tri-Corpus Test Matrix for lcp.preload-font-cors-mismatch"]
        subgraph P ["Positive Corpus (tests/correctness/lcp.preload-font-cors-mismatch/positive/)"]
        ...
        subgraph N ["Negative Corpus (tests/correctness/lcp.preload-font-cors-mismatch/negative/)"]
        ...
        subgraph A ["Adversarial Corpus (tests/correctness/lcp.preload-font-cors-mismatch/adversarial/)"]
