...
func TestRule_CLSClientOnlyHydrationPop_TriCorpus(t *testing.T) {
	rule := cls.NewClientOnlyHydrationPopRule()
	baseDir := filepath.Join(".", "cls", "client-only-hydration-pop")
