...
func TestRule_CLSUnstableScrollbarGutter_TriCorpus(t *testing.T) {
	rule := cls.NewUnstableScrollbarGutterRule()
	baseDir := filepath.Join(".", "cls", "unstable-scrollbar-gutter")
