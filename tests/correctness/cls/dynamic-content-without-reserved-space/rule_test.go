...
func TestRule_CLSDynamicContentWithoutReservedSpace_TriCorpus(t *testing.T) {
	rule := cls.NewDynamicContentWithoutReservedSpaceRule()
	baseDir := filepath.Join(".", "cls", "dynamic-content-without-reserved-space")
