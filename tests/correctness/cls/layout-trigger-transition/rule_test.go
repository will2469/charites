...
func TestRule_CLSLayoutTriggerTransition_TriCorpus(t *testing.T) {
	rule := cls.NewLayoutTriggerTransitionRule()
	baseDir := filepath.Join(".", "cls", "layout-trigger-transition")
