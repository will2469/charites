...
func TestRule_CLSFontImportLateDiscovery_TriCorpus(t *testing.T) {
	rule := cls.NewFontImportLateDiscoveryRule()
	baseDir := filepath.Join(".", "cls", "font-import-late-discovery")
