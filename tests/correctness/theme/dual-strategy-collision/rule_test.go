...
func TestRule_ThemeDualStrategyCollision_TriCorpus(t *testing.T) {
	rule := theme.NewDualStrategyCollisionRule()
	baseDir := filepath.Join(".", "theme", "dual-strategy-collision")
