...
func TestRule_ThemeMetaThemeColorMismatch_TriCorpus(t *testing.T) {
	rule := theme.NewMetaThemeColorMismatchRule()
	baseDir := filepath.Join(".", "theme", "meta-theme-color-mismatch")
