...
func TestRule_ThemeUnlayeredTokenDefinition_TriCorpus(t *testing.T) {
	rule := theme.NewUnlayeredTokenDefinitionRule()
	baseDir := filepath.Join(".", "theme", "unlayered-token-definition")
