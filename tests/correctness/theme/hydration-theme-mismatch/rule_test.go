...
func TestRule_ThemeHydrationThemeMismatch_TriCorpus(t *testing.T) {
	rule := theme.NewHydrationThemeMismatchRule()
	baseDir := filepath.Join(".", "theme", "hydration-theme-mismatch")
