...
func TestRule_MobileKeyboardViewportRisk_TriCorpus(t *testing.T) {
	rule := mobile.NewKeyboardViewportRiskRule()
	baseDir := filepath.Join(".", "mobile", "keyboard-viewport-risk")
