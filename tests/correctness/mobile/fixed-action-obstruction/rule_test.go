...
func TestRule_MobileFixedActionObstruction_TriCorpus(t *testing.T) {
	rule := mobile.NewFixedActionObstructionRule()
	baseDir := filepath.Join(".", "mobile", "fixed-action-obstruction")
