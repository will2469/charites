...
func TestRule_UXEmptyCollectionUnhandled_TriCorpus(t *testing.T) {
	rule := ux.NewEmptyCollectionUnhandledRule()
	baseDir := filepath.Join(".", "ux", "empty-collection-unhandled")
