...
func TestRule_UXNumberInputMissingBounds_TriCorpus(t *testing.T) {
	rule := ux.NewNumberInputMissingBoundsRule()
	baseDir := filepath.Join(".", "ux", "number-input-missing-bounds")
