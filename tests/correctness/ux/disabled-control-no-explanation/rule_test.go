...
func TestRule_UXDisabledControlNoExplanation_TriCorpus(t *testing.T) {
	rule := ux.NewDisabledControlNoExplanationRule()
	baseDir := filepath.Join(".", "ux", "disabled-control-no-explanation")
