...
func TestRule_UXNumberInputIdentityMisuse_TriCorpus(t *testing.T) {
	rule := ux.NewNumberInputIdentityMisuseRule()
	baseDir := filepath.Join(".", "ux", "number-input-identity-misuse")
