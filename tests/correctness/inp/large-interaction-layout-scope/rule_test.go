...
func TestRule_INPLargeInteractionLayoutScope_TriCorpus(t *testing.T) {
	rule := inp.NewLargeInteractionLayoutScopeRule()
	baseDir := filepath.Join(".", "inp", "large-interaction-layout-scope")
