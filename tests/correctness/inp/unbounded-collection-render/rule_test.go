...
func TestRule_INPUnboundedCollectionRender_TriCorpus(t *testing.T) {
	rule := inp.NewUnboundedCollectionRenderRule()
	baseDir := filepath.Join(".", "inp", "unbounded-collection-render")
