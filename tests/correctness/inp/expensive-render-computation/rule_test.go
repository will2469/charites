...
func TestRule_INPExpensiveRenderComputation_TriCorpus(t *testing.T) {
	rule := inp.NewExpensiveRenderComputationRule()
	baseDir := filepath.Join(".", "inp", "expensive-render-computation")
