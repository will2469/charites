...
func TestRule_INPContextReRenderCascade_TriCorpus(t *testing.T) {
	rule := inp.NewContextReRenderCascadeRule()
	baseDir := filepath.Join(".", "inp", "context-re-render-cascade")
