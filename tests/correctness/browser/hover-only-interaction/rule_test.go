...
func TestRule_BrowserHoverOnlyInteraction_TriCorpus(t *testing.T) {
	rule := browser.NewHoverOnlyInteractionRule()
	baseDir := filepath.Join(".", "browser", "hover-only-interaction")
