...
func TestRule_BrowserScrollbarVendorIncomplete_TriCorpus(t *testing.T) {
	rule := browser.NewScrollbarVendorIncompleteRule()
	baseDir := filepath.Join(".", "browser", "scrollbar-vendor-incomplete")
