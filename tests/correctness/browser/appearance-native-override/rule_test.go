...
func TestRule_BrowserAppearanceNativeOverride_TriCorpus(t *testing.T) {
	rule := browser.NewAppearanceNativeOverrideRule()
	baseDir := filepath.Join(".", "browser", "appearance-native-override")
