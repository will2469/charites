...
func TestRule_BrowserDateInputFormatAssumption_TriCorpus(t *testing.T) {
	rule := browser.NewDateInputFormatAssumptionRule()
	baseDir := filepath.Join(".", "browser", "date-input-format-assumption")
