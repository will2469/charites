...
func TestRule_BrowserObsoleteVendorPrefix_TriCorpus(t *testing.T) {
	rule := browser.NewObsoleteVendorPrefixRule()
	baseDir := filepath.Join(".", "browser", "obsolete-vendor-prefix")
