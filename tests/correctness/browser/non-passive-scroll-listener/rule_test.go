...
func TestRule_BrowserNonPassiveScrollListener_TriCorpus(t *testing.T) {
	rule := browser.NewNonPassiveScrollListenerRule()
	baseDir := filepath.Join(".", "browser", "non-passive-scroll-listener")
