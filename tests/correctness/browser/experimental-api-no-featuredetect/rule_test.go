...
func TestRule_BrowserExperimentalAPINoFeaturedetect_TriCorpus(t *testing.T) {
	rule := browser.NewExperimentalAPINoFeaturedetectRule()
	baseDir := filepath.Join(".", "browser", "experimental-api-no-featuredetect")
