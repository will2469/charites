...
func TestRule_PwaServiceWorkerRegistration_TriCorpus(t *testing.T) {
	rule := pwa.NewServiceWorkerRegistrationRule()
	baseDir := filepath.Join(".", "pwa", "service-worker-registration")
