...
func TestRule_PwaManifestRequiredFieldsMissing_TriCorpus(t *testing.T) {
	rule := pwa.NewManifestRequiredFieldsMissingRule()
	baseDir := filepath.Join(".", "pwa", "manifest-required-fields-missing")
