...
func TestRule_PwaServiceWorkerNoOfflineFallback_TriCorpus(t *testing.T) {
	rule := pwa.NewServiceWorkerNoOfflineFallbackRule()
	baseDir := filepath.Join(".", "pwa", "service-worker-no-offline-fallback")
