...
func TestRule_PwaInsecureContextResource_TriCorpus(t *testing.T) {
	rule := pwa.NewInsecureContextResourceRule()
	baseDir := filepath.Join(".", "pwa", "insecure-context-resource")
