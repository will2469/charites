...
func TestRule_LCPCriticalHeadStyleBloat_TriCorpus(t *testing.T) {
	rule := lcp.NewCriticalHeadStyleBloatRule()
	baseDir := filepath.Join(".", "lcp", "critical-head-style-bloat")
