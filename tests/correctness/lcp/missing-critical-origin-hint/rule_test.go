...
func TestRule_LCPMissingCriticalOriginHint_TriCorpus(t *testing.T) {
	rule := lcp.NewMissingCriticalOriginHintRule()
	baseDir := filepath.Join(".", "lcp", "missing-critical-origin-hint")
