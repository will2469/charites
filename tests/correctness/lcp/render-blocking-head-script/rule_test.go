...
func TestRule_LCPRenderBlockingHeadScript_TriCorpus(t *testing.T) {
	rule := lcp.NewRenderBlockingHeadScriptRule()
	baseDir := filepath.Join(".", "lcp", "render-blocking-head-script")
