...
func TestRule_LCPUnhintedLCPImagePriority_TriCorpus(t *testing.T) {
	rule := lcp.NewUnhintedLCPImagePriorityRule()
	baseDir := filepath.Join(".", "lcp", "unhinted-lcp-image-priority")
