...
func TestRule_LCPPreloadFontCORSMismatch_TriCorpus(t *testing.T) {
	rule := lcp.NewPreloadFontCORSMismatchRule()
	baseDir := filepath.Join(".", "lcp", "preload-font-cors-mismatch")
