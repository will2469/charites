...
func TestRule_LCPImageSourceDensityMismatch_TriCorpus(t *testing.T) {
	rule := lcp.NewImageSourceDensityMismatchRule()
	baseDir := filepath.Join(".", "lcp", "image-source-density-mismatch")
