...
func TestRule_LCPLegacyCriticalFontResource_TriCorpus(t *testing.T) {
	rule := lcp.NewLegacyCriticalFontResourceRule()
	baseDir := filepath.Join(".", "lcp", "legacy-critical-font-resource")
