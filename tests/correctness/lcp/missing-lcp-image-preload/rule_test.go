...
func TestRule_LCPMissingLCPImagePreload_TriCorpus(t *testing.T) {
	rule := lcp.NewMissingLCPImagePreloadRule()
	baseDir := filepath.Join(".", "lcp", "missing-lcp-image-preload")
