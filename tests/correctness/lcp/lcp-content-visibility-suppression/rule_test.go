...
func TestRule_LCPLCPContentVisibilitySuppression_TriCorpus(t *testing.T) {
	rule := lcp.NewContentVisibilitySuppressionRule()
	baseDir := filepath.Join(".", "lcp", "lcp-content-visibility-suppression")
