...
func TestRule_LCPOversizedLCPResourceSelection_TriCorpus(t *testing.T) {
	rule := lcp.NewOversizedLCPResourceSelectionRule()
	baseDir := filepath.Join(".", "lcp", "oversized-lcp-resource-selection")
