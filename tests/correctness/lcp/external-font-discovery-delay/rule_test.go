...
func TestRule_LCPExternalFontDiscoveryDelay_TriCorpus(t *testing.T) {
	rule := lcp.NewExternalFontDiscoveryDelayRule()
	baseDir := filepath.Join(".", "lcp", "external-font-discovery-delay")
