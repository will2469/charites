...
func TestRule_ResponsiveMissingBreakpoint_TriCorpus(t *testing.T) {
	rule := responsive.NewMissingBreakpointRule()
	baseDir := filepath.Join(".", "responsive", "missing-breakpoint")
