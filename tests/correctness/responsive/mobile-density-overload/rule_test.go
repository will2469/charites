...
func TestRule_ResponsiveMobileDensityOverload_TriCorpus(t *testing.T) {
	rule := responsive.NewMobileDensityOverloadRule()
	baseDir := filepath.Join(".", "responsive", "mobile-density-overload")
