...
func TestRule_ResponsiveUnwrappedTableOverflow_TriCorpus(t *testing.T) {
	rule := responsive.NewUnwrappedTableOverflowRule()
	baseDir := filepath.Join(".", "responsive", "unwrapped-table-overflow")
