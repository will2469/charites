...
func TestRule_ResponsiveDesktopOnlyContent_TriCorpus(t *testing.T) {
	rule := responsive.NewDesktopOnlyContentRule()
	baseDir := filepath.Join(".", "responsive", "desktop-only-content")
