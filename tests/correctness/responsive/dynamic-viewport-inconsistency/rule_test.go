...
func TestRule_ResponsiveDynamicViewportInconsistency_TriCorpus(t *testing.T) {
	rule := responsive.NewDynamicViewportInconsistencyRule()
	baseDir := filepath.Join(".", "responsive", "dynamic-viewport-inconsistency")
