...
func TestRule_ResponsiveHorizontalOverflow_TriCorpus(t *testing.T) {
	rule := responsive.NewHorizontalOverflowRule()
	baseDir := filepath.Join(".", "responsive", "horizontal-overflow")
