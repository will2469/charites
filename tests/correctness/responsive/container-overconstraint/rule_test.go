...
func TestRule_ResponsiveContainerOverconstraint_TriCorpus(t *testing.T) {
	rule := responsive.NewContainerOverconstraintRule()
	baseDir := filepath.Join(".", "responsive", "container-overconstraint")
