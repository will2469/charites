...
func TestRule_ResponsiveKeyboardObstruction_TriCorpus(t *testing.T) {
	rule := responsive.NewKeyboardObstructionRule()
	baseDir := filepath.Join(".", "responsive", "keyboard-obstruction")
