...
func TestRule_ResponsiveAspectRatioOverflow_TriCorpus(t *testing.T) {
	rule := responsive.NewAspectRatioOverflowRule()
	baseDir := filepath.Join(".", "responsive", "aspect-ratio-overflow")
