...
func TestRule_ResponsiveMobileTextOverflow_TriCorpus(t *testing.T) {
	rule := responsive.NewMobileTextOverflowRule()
	baseDir := filepath.Join(".", "responsive", "mobile-text-overflow")
