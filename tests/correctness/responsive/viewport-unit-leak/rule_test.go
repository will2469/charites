...
func TestRule_ResponsiveViewportUnitLeak_TriCorpus(t *testing.T) {
	rule := responsive.NewViewportUnitLeakRule()
	baseDir := filepath.Join(".", "responsive", "viewport-unit-leak")
