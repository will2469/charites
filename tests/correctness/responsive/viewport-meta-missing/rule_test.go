...
func TestRule_ResponsiveViewportMetaMissing_TriCorpus(t *testing.T) {
	rule := responsive.NewViewportMetaMissingRule()
	baseDir := filepath.Join(".", "responsive", "viewport-meta-missing")
