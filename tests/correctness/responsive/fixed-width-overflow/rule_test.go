...
func TestRule_ResponsiveFixedWidthOverflow_TriCorpus(t *testing.T) {
	rule := responsive.NewFixedWidthOverflowRule()
	baseDir := filepath.Join(".", "responsive", "fixed-width-overflow")
