...
func TestRule_ErgonomyMissingInputmodeKeyboard_TriCorpus(t *testing.T) {
	rule := ergonomy.NewMissingInputmodeKeyboardRule()
	baseDir := filepath.Join(".", "ergonomy", "missing-inputmode-keyboard")
