...
func TestRule_ErgonomyNumberInputWheelHazard_TriCorpus(t *testing.T) {
	rule := ergonomy.NewNumberInputWheelHazardRule()
	baseDir := filepath.Join(".", "ergonomy", "number-input-wheel-hazard")
