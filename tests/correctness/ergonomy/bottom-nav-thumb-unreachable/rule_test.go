...
func TestRule_ErgonomyBottomNavThumbUnreachable_TriCorpus(t *testing.T) {
	rule := ergonomy.NewBottomNavThumbUnreachableRule()
	baseDir := filepath.Join(".", "ergonomy", "bottom-nav-thumb-unreachable")
