...
func TestRule_ErgonomyGestureWithoutTouchAction_TriCorpus(t *testing.T) {
	rule := ergonomy.NewGestureWithoutTouchActionRule()
	baseDir := filepath.Join(".", "ergonomy", "gesture-without-touch-action")
