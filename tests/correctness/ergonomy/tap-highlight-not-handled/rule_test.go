...
func TestRule_ErgonomyTapHighlightNotHandled_TriCorpus(t *testing.T) {
	rule := ergonomy.NewTapHighlightNotHandledRule()
	baseDir := filepath.Join(".", "ergonomy", "tap-highlight-not-handled")
