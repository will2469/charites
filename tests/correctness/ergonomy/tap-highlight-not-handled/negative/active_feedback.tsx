...
export function ActiveFeedbackCard({ onSelect }: { onSelect: () => void }) {
  return (
    ...
    <div
      ...
      tabIndex={0}
      onClick={onSelect}
      className="p-4 bg-card border rounded-2xl cursor-pointer active:bg-muted/60 active:scale-95 transition-transform [-webkit-tap-highlight-color:transparent]"
    >
