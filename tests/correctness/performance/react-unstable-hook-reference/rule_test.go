...
func TestRule_PerformanceReactUnstableHookReference_TriCorpus(t *testing.T) {
	rule := performance.NewReactUnstableHookReferenceRule()
	baseDir := filepath.Join(".", "performance", "react-unstable-hook-reference")
