...
func TestRule_PerformanceReactStaticHeavyImport_TriCorpus(t *testing.T) {
	rule := performance.NewReactStaticHeavyImportRule()
	baseDir := filepath.Join(".", "performance", "react-static-heavy-import")
