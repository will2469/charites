...
func TestRule_PerformanceTailwindDuplicateUtilityDefinition_TriCorpus(t *testing.T) {
	rule := performance.NewTailwindDuplicateUtilityDefinitionRule()
	baseDir := filepath.Join(".", "performance", "tailwind-duplicate-utility-definition")
