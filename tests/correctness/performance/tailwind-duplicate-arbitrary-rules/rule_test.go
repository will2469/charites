...
func TestRule_PerformanceTailwindDuplicateArbitraryRules_TriCorpus(t *testing.T) {
	rule := performance.NewTailwindDuplicateArbitraryRulesRule()
	baseDir := filepath.Join(".", "performance", "tailwind-duplicate-arbitrary-rules")
