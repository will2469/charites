...
func TestRule_PerformanceAstroUnnecessaryClientDirective_TriCorpus(t *testing.T) {
	rule := performance.NewAstroUnnecessaryClientDirectiveRule()
	baseDir := filepath.Join(".", "performance", "astro-unnecessary-client-directive")
