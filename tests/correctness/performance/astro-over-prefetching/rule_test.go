...
func TestRule_PerformanceAstroOverPrefetching_TriCorpus(t *testing.T) {
	rule := performance.NewAstroOverPrefetchingRule()
	baseDir := filepath.Join(".", "performance", "astro-over-prefetching")
