...
func TestRule_PerformanceReactIndexAsKey_TriCorpus(t *testing.T) {
	rule := performance.NewReactIndexAsKeyRule()
	baseDir := filepath.Join(".", "performance", "react-index-as-key")
