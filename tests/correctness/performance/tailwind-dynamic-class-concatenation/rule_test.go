...
func TestRule_PerformanceTailwindDynamicClassConcatenation_TriCorpus(t *testing.T) {
	rule := performance.NewTailwindDynamicClassConcatenationRule()
	baseDir := filepath.Join(".", "performance", "tailwind-dynamic-class-concatenation")
