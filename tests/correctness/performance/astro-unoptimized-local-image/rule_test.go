...
func TestRule_PerformanceAstroUnoptimizedLocalImage_TriCorpus(t *testing.T) {
	rule := performance.NewAstroUnoptimizedLocalImageRule()
	baseDir := filepath.Join(".", "performance", "astro-unoptimized-local-image")
