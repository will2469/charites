...
func TestRule_PerformanceReactContextDomainCoupling_TriCorpus(t *testing.T) {
	rule := performance.NewReactContextDomainCouplingRule()
	baseDir := filepath.Join(".", "performance", "react-context-domain-coupling")
