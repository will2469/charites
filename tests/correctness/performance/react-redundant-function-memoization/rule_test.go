...
func TestRule_PerformanceReactRedundantFunctionMemoization_TriCorpus(t *testing.T) {
	rule := performance.NewReactRedundantFunctionMemoizationRule()
	baseDir := filepath.Join(".", "performance", "react-redundant-function-memoization")
