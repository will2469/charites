...
func TestRule_PerformanceAstroIslandBoundaryOverlap_TriCorpus(t *testing.T) {
	rule := performance.NewAstroIslandBoundaryOverlapRule()
	baseDir := filepath.Join(".", "performance", "astro-island-boundary-overlap")
