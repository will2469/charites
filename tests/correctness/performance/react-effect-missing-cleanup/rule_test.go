...
func TestRule_PerformanceReactEffectMissingCleanup_TriCorpus(t *testing.T) {
	rule := performance.NewReactEffectMissingCleanupRule()
	baseDir := filepath.Join(".", "performance", "react-effect-missing-cleanup")
