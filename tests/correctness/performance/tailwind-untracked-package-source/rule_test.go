...
func TestRule_PerformanceTailwindUntrackedPackageSource_TriCorpus(t *testing.T) {
	rule := performance.NewTailwindUntrackedPackageSourceRule()
	baseDir := filepath.Join(".", "performance", "tailwind-untracked-package-source")
