...
func TestRule_PerformanceReactInlinePropMemo_TriCorpus(t *testing.T) {
	rule := performance.NewReactInlinePropMemoRule()
	baseDir := filepath.Join(".", "performance", "react-inline-prop-memo")
