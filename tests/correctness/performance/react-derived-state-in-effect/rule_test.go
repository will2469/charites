...
func TestRule_PerformanceReactDerivedStateInEffect_TriCorpus(t *testing.T) {
	rule := performance.NewReactDerivedStateInEffectRule()
	baseDir := filepath.Join(".", "performance", "react-derived-state-in-effect")
