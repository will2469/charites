...
// BenchmarkResponsiveRules_ZeroAllocClean menguji seluruh rule kategori responsive terhadap node bersih
// untuk memastikan garansi nol alokasi heap (0 B/op, 0 allocs/op) sesuai persyaratan QUAL-03.
func BenchmarkResponsiveRules_ZeroAllocClean(b *testing.B) {
