...
// BenchmarkBrowserRules_ZeroAllocClean menguji seluruh rule kategori browser terhadap node bersih
// untuk memastikan garansi nol alokasi heap (0 B/op, 0 allocs/op) sesuai persyaratan QUAL-03.
func BenchmarkBrowserRules_ZeroAllocClean(b *testing.B) {
	...
	cleanNode := &ir.Node{
		...
		Classes:    []string{"appearance-none", "h-11", "w-11", "p-2.5", "focus-visible:ring-2", "text-base"},
